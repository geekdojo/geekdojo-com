...
Source for **[geekdojo.com](https://geekdojo.com)** — a static company page.
Plain HTML/CSS in `site/`, no build step; pushes to `master` deploy to Azure
Static Web Apps via `.github/workflows/`.
